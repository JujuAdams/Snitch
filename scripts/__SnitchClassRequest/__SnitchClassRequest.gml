...
function __SnitchSentryHTTPRequest(_request)
{
    ...
    _request.__Send(__snitchState.__Endpoint, "POST", __snitchState.__HTTPHeaderMap, _envelopeString);
...
function __SnitchGameAnalyticsHTTPRequest(_request)
{
    ...
    _request.__Send(__snitchState.__Endpoint, "POST", __snitchState.__HTTPHeaderMap, _request.content);
...
function __SnitchBugsnagHTTPRequest(_request)
{
    ...
    _request.__Send("https://notify.bugsnag.com", "POST", __snitchState.__HTTPHeaderMap, _request.content);
...
function __SnitchGenericHTTPRequest(_request)
{
    ...
    _request.__Send(SNITCH_GENERIC_URL, SNITCH_GENERIC_METHOD, __snitchState.__HTTPHeaderMap, _request.content);
