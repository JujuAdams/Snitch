...
//   N.B. Logging to file will initially be set to disabled even if SNITCH_LOG_FILE_PERMITTED is <true>
//        Either call SnitchLogFileSet(true), or set SNITCH_LOG_FILE_ON_BOOT to <true>, to enable logging
#macro SNITCH_LOG_FILE_PERMITTED  true
...
#macro SNITCH_ALLOW_LOG_FILE_BOOT_PARAMETER  true

//Pop-up message to show when the game is booted with the "-log" execution parameter
#macro SNITCH_LOG_FILE_BOOT_PARAMETER_CONFIRMATION  ("Logging enabled! You can find the logs in " + string(game_save_id))

//Name of the log files to save. Use a # symbol for number position
#macro SNITCH_LOG_FILE_FILENAME  "log_#.txt"
